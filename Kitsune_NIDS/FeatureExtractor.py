...
if use_extrapolation:
    print("AfterImage Cython Kütüphanesini İçe Aktarma")
...
import csv
import numpy as np
print("Scapy Kütüphanesini İçe Aktarma")
...
class FE:
    ...
    def __prep__(self):
        ...
        ##If file is pcap
            ...
            if os.path.isfile(self._tshark):
                ...
                print("tshark bulunamadı. Scapy deneniyor...")
        ...
        if self.parse_type == "tsv":
            ...
            print("dosyadaki satırları sayma...")
            num_lines = sum(1 for line in open(self.path))
            print("Dosyada " + str(num_lines) + " Packet bulunuyor.")
            ...
            print("PCAP dosyasını Scapy aracılığıyla okuma...")
            self.scapyin = rdpcap(self.path)
            self.limit = len(self.scapyin)
            print("Yüklenen " + str(len(self.scapyin)) + " Paket.")
    ...
    def get_next_vector(self):
        ...
        packet = None  # Başlangıç değeri atama
        ...
        self.packet = packet  # Oluşturulan paketi sakla
    ...
    def pcap2tsv_with_tshark(self):
        ...
        subprocess.call(cmd,shell=True)
        print("tshark ayrıştırma tamamlandı. Dosya şu şekilde kaydedildi: "+self.path +".tsv")

    def get_num_features(self):
        return len(self.nstat.getNetStatHeaders())

    def detect_attack(self, anomaly):
        """
        Verilen bir anormalliğin saldırı türünü tespit eder.
        """
        return self.attack_type_detector.detect_attack_type(anomaly)

    def save_attack_logs(self, attack_logs):
        """
        Tespit edilen saldırı türlerini bir dosyaya kaydeder.
        """
